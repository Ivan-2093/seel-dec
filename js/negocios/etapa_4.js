...
const get_tecnicos = async () => {
    const url = `${base_url}NegociosController/get_tecnicos`;
...
const get_citas = async () => {
    const url = `${base_url}NegociosController/get_citas`;
    await execute_fetch(url, null)
        .then(resp => {
            if (resp.status) {
...
const get_info_citas = async (id_cita) => {
    const url = `${base_url}NegociosController/get_info_cita`;
...
function crear_cita() {
    ...
    if (!empty_field) {
        const url = `${base_url}NegociosController/crear_cita`;
