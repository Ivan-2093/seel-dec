    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <h5 class="card-header">SOLICITUD DEL CLIENTE</h5>
                        <div class="card-body">
                            <form id="formCreateSolicitudCliente" name="formCreateSolicitudCliente">
                                <div class="row">
                                    <div class="col-12">
                                        <label for="solicitud_cliente">SOLICITUD: </label>
                                        <textarea rows="5" id="solicitud_cliente" name="solicitud_cliente" placeholder="Escriba aquí detalladamente la solicitud del cliente" class="form-control" aria-label="With textarea"></textarea>
                                    </div>
                                </div>
