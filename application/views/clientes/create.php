...
<div class="row">
    <div class="col-12">
        <div class="card">
            <h5 class="card-header">FORMULARIO PARA CREAR CLIENTES</h5>
            <form id="formCreateCliente" name="formCreateCliente">
                ...
                <div class="card-footer text-right">
                    <button id="btnSubmitCreateCliente" name="btnSubmitCreateCliente" type="button" class="btn btn-success">CREAR</button>
                </div>
            </form>
        </div>
    </div>
