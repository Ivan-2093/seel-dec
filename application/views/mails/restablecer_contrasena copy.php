						...
						<tbody>
										...
										<tbody>
											<tr>
												<td style="
													...
													<a href="#" target="_blank" style="color: #0d1121; text-decoration: underline">SEELDEC</a>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<td valign="top" align="center">
									<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
										<tbody>
											<tr>
												<td valign="top" align="center">
													<img class="em_img" alt="merry Christmas" style="
																display: block;
																...
																color: #000000;
																max-width: 700px;
															" src="https://d375ed4q973kxa.cloudfront.net/cdn/13/images/curso-online-cuidados-gato_amp_primaria_1_1560503053.jpg" width="700" border="0" height="345" />
												</td>
											</tr>
										</tbody>
									</table>
							...
							<tr>
								<td style="padding: 35px 70px 30px" class="em_padd" valign="top" bgcolor="#0d1121" align="center">
										...
										<tbody>
											<tr>
												<td style="
															...
															color: #ffffff;
														" valign="top" align="center">
													Este mensaje es para recordale el compromiso que tiene para el proyecto SEELDEC
												</td>
											</tr>
											<tr>
												<td style="
									...
									<tr>
										<td class="em_hide" style="
											line-height: 1px;
											min-width: 700px;
											background-color: #ffffff;
										">
											<img alt="" src="https://e7.pngegg.com/pngimages/639/972/png-clipart-kitten-calico-cat-tortoiseshell-cat-popular-cat-names-kitten-face-cat-like-mammal.png" style="
												max-height: 1px;
												min-height: 1px;
												display: block;
												width: 700px;
