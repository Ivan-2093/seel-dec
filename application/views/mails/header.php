                                ...
                                <td valign="top" align="center">
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td valign="top" align="center">
                                                    <img class="em_img" alt="Seguridad Electronica y Decoración" style="
																display: block;
																font-family: Arial, sans-serif;
																font-size: 16px;
																line-height: 30px;
																max-width: 700px;
															" src="https://aftersalesassistance.com/plantilla/img/icons/logo-seeldec.jpeg" width="auto" border="0" height="100%" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
